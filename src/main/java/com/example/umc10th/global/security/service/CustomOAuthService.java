...
import com.example.umc10th.global.security.entity.OAuthUser;
...
public class CustomOAuthService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(
        ...
        User member = memberRepository.findBySocialTypeAndSocialUid(providerId, socialUid)
                .orElseGet(() -> {
                    User newMember = UserConverter.toUser(dto);
                    memberRepository.save(newMember);
                    return newMember;
                });

        return new OAuthUser(member, oAuthMember.getAttributes());
    }
}